...
- radio "The font size should be bigger"
- text: The font size should be bigger
- radio "The products which have enough number of items in stock should be shown"
- text: The products which have enough number of items in stock should be shown
- radio "The page should show only 5 results on single page"
- text: The page should show only 5 results on single page
- radio "The selected number of results is displayed according to the clicked buttons"
- text: The selected number of results is displayed according to the clicked buttons
- button "Submit"
```